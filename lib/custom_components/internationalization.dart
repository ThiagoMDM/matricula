...
class PDM2LocalizationsDelegate
    extends LocalizationsDelegate<CustomLocalizations> {
  const PDM2LocalizationsDelegate();

  @override
  bool isSupported(Locale locale) {
    final language = locale.toString();
    return CustomLocalizations.languages().contains(
      language.endsWith('_')
  ...
  @override
  bool shouldReload(PDM2LocalizationsDelegate old) => false;
}
