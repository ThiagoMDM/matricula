...
import '../../custom_components/uploaded_file.dart';
...
class ApiManager {
  ...
  static Future<ApiCallResponse> multipartRequest(
    ...
    bool Function(dynamic) _isFile = (e) =>
        e is CustomUploadedFile ||
        e is List<CustomUploadedFile> ||
        (e is List && e.firstOrNull is CustomUploadedFile);
    ...
    params.entries.where((e) => _isFile(e.value)).forEach((e) {
      ...
      final uploadedFiles = param is List
          ? param as List<CustomUploadedFile>
          : [param as CustomUploadedFile];
